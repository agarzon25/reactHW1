...
class App extends Component {
  ...
  state = {
    ...
    currentScore: 0,
    maxScore: 0,
    navNote: "Click on a Dog to begin!"
  };
  ...
  updateState = id => {
    ...
    if(Image.clicked === false) {
      ...
      this.Shuffle(images);
      this.setState({ images });
      this.setState({ navNote: "Nice! Continue choosing a different Dog!" });
      ...
      this.gameWon(this.state.currentScore);
        ...
        this.setState({ images });
        this.setState({ navNote: "OH NO! You clicked on that Dog already!" });
        this.setState({ currentScore: 0});
    };
